...
| 3 — Source of truth | — | [`docs/paper/`](docs/paper/) — original PDF + extracted text |
...
├── docs/
│   ├── context/              ← the paper digested into 8 self-contained parts (levels 1–2)
│   └── paper/                ← original PDF + extracted text (level 3, source of truth)
